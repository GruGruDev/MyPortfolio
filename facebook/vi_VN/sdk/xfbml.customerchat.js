/*1720439969,,JIT Construction: v1014716879,vi_VN*/
      ...
      (function () {
        ...
        with (this) {
            ...
            function (a, b, c, d, e, f) {
              ...
              function ca(a) {
                ...
                if (
                  ...
                  return "warn";
                return a.stack != null &&
                  a.stack.indexOf("chrome-extension_/index.html") >= 0
                  ? "warn"
                  : "error";
              }
              var z = [],
          ...
          __d(
            ...
            function (a, b, c, d, e, f) {
              var g = new RegExp(
                "%5e(%5b%5e_/indexd41d.html?#]+:)?(//([^\\\\/?#@]*@)?(\\[[A-Fa-f0-9:.]+\\]|[^\\/?#:]*)(:[0-9]*)?)?([^?#]*)(\\?[^#]*)?(#.*)?"
              );
              function a(a) {
              ...
              a = (function () {
                ...
                a.parse = function (c, d, e, f) {
                  ...
                  if (
                    c.getDomain() &&
                    c.getPath() &&
                    !ES(c.getPath(), "startsWith", !0, "index.html")
                  ) {
                    if (e)
                      throw new Error(
                ...
                if (typeof a === "string")
                  if (c("sdk.Runtime").getIsVersioned()) {
                    ...
                    d("sdk.PlatformVersioning").REGEX.test(
                      g.substring(1, g.indexOf("index.html", 1))
              ...
              var p = {
                ...
                prepareCall: function (a, b) {
                  ...
                  if (
                    ...
                    f.url.substring(0, 7) === "dialog/index.html"
                  ) {
            ...
            function (a, b, c, d, e, f, g) {
              ...
              b = {
                continueWith: (a = c("sdk.fbt"))._(
                  "Ti\u1ebfp t\u1ee5c v\u1edbi {facebook_app_name} ho\u1eb7c {instagram_app_name}"
                ),
                continueWithShort: a._(
                  "{facebook_app_name} ho\u1eb7c {instagram_app_name}"
                ),
                loginButtonAriaLabel: a._(
                  "Ti\u1ebfp t\u1ee5c b\u1eb1ng Facebook ho\u1eb7c Instagram"
                ),
                logout: a._("\u0110\u0103ng xu\u1ea5t"),
                logoutButtonAriaLabel: a._(
                  "\u0110\u0103ng xu\u1ea5t kh\u1ecfi trang web hi\u1ec7n t\u1ea1i"
                ),
                titleText: a._("Ch\u1ecdn t\u00e0i kho\u1ea3n"),
                promptText: a._(
                  "B\u1ea1n mu\u1ed1n d\u00f9ng t\u00e0i kho\u1ea3n n\u00e0o \u0111\u1ec3 \u0111\u0103ng nh\u1eadp?"
                ),
                facebookText: a._(
              ...
              function a() {
                function a(a, b) {
                  ...
                  try {
                    ...
                    e =
                      f === b.getDomain() &&
                      ES(a, "includes", !0, "rsrc.php/index.html");
                  } catch (a) {
                    d("Log").error(
  ...
  i.src =
    ...
    encodeURIComponent(
      '{"error":"LOAD", "extra": {"name":"' +
        ...
        '","revision":"1014716879","namespace":"FB","message":"' +
        e.message +
        '"}}'
    );
