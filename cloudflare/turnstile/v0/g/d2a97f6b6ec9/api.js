...
(function () {
  ...
  function Be(e) {
    for (var a = 1; a < arguments.length; a++) {
      ...
      typeof Object.getOwnPropertySymbols == "function" &&
        (o = o.concat(
          Object.getOwnPropertySymbols(r).filter(function (c) {
  ...
  function Tt(e, a) {
    return (
      ...
      Object.getOwnPropertyDescriptors
        ...
        : fr(Object(a)).forEach(function (r) {
    ...
    if (
      (e.params._debugSitekeyOverrides &&
        (e.params._debugSitekeyOverrides.offlabel !== "default" &&
          a.set("offlabel", e.params._debugSitekeyOverrides.offlabel),
  ...
  function lt(e, a, r, o, c, u, g) {
    var b = ut(r, c),
      ...
      l = g ? "?".concat(g) : "";
    return ""
      .concat(b, "/cdn-cgi/challenge-platform/")
  ...
  function Kt() {
    ...
    var a = { loadedAsync: !1, params: new URLSearchParams() };
  ...
  function $t(e, a) {
    ...
    (h.className = "cf-turnstile-feedback"),
      (h.id = "cf-fr-id"),
    ...
    N(
      k,
      (R =
        (r = a.displayLanguage) === null || r === void 0
          ? void 0
          : r.toLowerCase()) !== null && R !== void 0
        ? R
        : "nonexistent"
    )
      ...
      : N(
          F,
          (S =
            (o = a.displayLanguage) === null || o === void 0
              ? void 0
              : o.toLowerCase()) !== null && S !== void 0
            ? S
            : "nonexistent"
        )
      ? (h.style.height = "480px")
      : (h.style.height = "460px"),
      (h.style.position = "absolute"),
      (h.style.zIndex = "21474836420"),
      (h.style.borderWidth = "1px"),
      (h.style.borderColor = "#000"),
    ...
    (v.id = e + "-fr"),
      ...
      v.setAttribute("allow", "cross-origin-isolated; fullscreen"),
      v.setAttribute(
        "sandbox",
    ...
    (n.style.position = "absolute"),
      (n.style.width = "26px"),
      (n.style.height = "26px"),
      (n.style.zIndex = "21474836421"),
      (n.style.cursor = "pointer"),
      a.displayRTL ? (n.style.left = "6px") : (n.style.right = "2px"),
      (n.style.top = "5px"),
      n.setAttribute("width", "26"),
    ...
    d.setAttribute("stroke-width", "3"),
      ...
      h.appendChild(n),
      l.appendChild(h),
      (c = _.parentNode) === null || c === void 0 || c.appendChild(l);
  }
  function Jt(e) {
    var a, r, o;
    (o = document.getElementById(e)) === null ||
      o === void 0 ||
      (r = o.parentElement) === null ||
      r === void 0 ||
      (a = r.parentElement) === null ||
      a === void 0 ||
      a.remove();
  }
  var dt = function (e) {
  ...
  function Zt(e) {
    var a = function (r, o) {
      ...
      for (var c = 1, u = r.previousElementSibling; u; )
        u.tagName === r.tagName && c++, (u = u.previousElementSibling);
    ...
    if (typeof e != "string")
      throw new Error(
        "djb2: expected string, got ".concat(
          typeof e == "undefined" ? "undefined" : C(e)
        )
      );
  ...
  function nr(e, a) {
    ...
    return r
      ? ((a.isReady = r.isReady),
        (a.isRecaptchaCompatibilityMode = r.isRecaptchaCompatibilityMode),
        (a.lastWidgetIdx = r.lastWidgetIdx),
        (a.scriptWasLoadedAsync = r.scriptWasLoadedAsync),
        (a.upgradeAttempts = r.upgradeAttempts),
        (a.upgradeCompletedCount = r.upgradeCompletedCount + 1),
        (a.turnstileLoadInitTimeMs = D()),
        (a.watchCatInterval = null),
        (a.watchCatSeq = r.watchCatSeq),
        (a.widgetMap = r.widgetMap),
        !0)
      : !1;
  }
  var yr = 900,
  ...
  function _r(e, a) {
    ...
    try {
      for (
        var u = e.widgetMap[Symbol.iterator](), g;
        !(r = (g = u.next()).done);
        r = !0
      ) {
        var b = Oe(g.value, 2),
          ...
          l = b[1],
          h;
        (l.watchcat.seq = e.watchCatSeq),
          l.watchcat.lastAckedSeq === 0 &&
            (l.watchcat.lastAckedSeq = e.watchCatSeq);
        var k = Q(_);
        if (!k) {
          l.watchcat.missingWidgetWarning ||
            (x(
            ...
            (l.watchcat.missingWidgetWarning = !0));
          continue;
        }
        ...
        if (!(l.isComplete || l.isFailed)) {
          if (
            (l.isExecuting ||
              !l.isInitialized ||
              (l.isInitialized && !l.isStale && !l.isExecuted)) &&
            l.watchcat.lastAckedSeq !== 0 &&
            l.watchcat.lastAckedSeq < l.watchcat.seq - 1 - hr
          ) {
            var R;
            (l.watchcat.lastAckedSeq = 0),
              (l.watchcat.seq = 0),
              (l.isExecuting = !1),
              console.log("Turnstile Widget seem to have crashed: ", _);
            var S;
            if (
              ((R = e.msgHandler) === null ||
                R === void 0 ||
          ...
          (h = F.contentWindow) === null ||
            h === void 0 ||
            h.postMessage(
              { source: P, widgetId: _, seq: e.watchCatSeq, event: "meow" },
              "*"
            );
        }
      }
  ...
  function yt() {
    var e = [Mt, Pt];
    y.isRecaptchaCompatibilityMode && e.push(Dt),
  ...
  var ht = (function () {
    var e = function (n, i, t, d) {
      ...
      o = function (n) {
        if (!n) return [];
        for (
          var i = n.attributes, t = i.length, d = new Array(t), f = 0;
          f < t;
          f++
        )
          d[f] = i[f].name;
      ...
      g = function (n, i, t) {
        for (; n.msgQueue.length; ) {
          ...
          (d = t.contentWindow) === null ||
            d === void 0 ||
            d.postMessage({ source: P, widgetId: i, event: f }, "*");
        }
      },
      b = function (n, i) {
        if (i) {
      ...
      _ = function (n) {
        ...
        if (t) {
          (t.isResetting = !0),
            ...
            (t.watchcat.seq = 0),
            t.params.execution === ue.RENDER &&
              (t.msgQueue.push(ee.EXECUTE),
              (t.isExecuted = !0),
              (t.isExecuting = !0));
          var d = Q(i),
            f = document.querySelector("#".concat(d));
          (!d || !f) &&
            p("Widget ".concat(i, " to reset was not found."), 3330),
            t.params.appearance === q.INTERACTION_ONLY && ir(f),
      ...
      h = function (n, i) {
        ...
        if (typeof n == "string")
          try {
            ...
            E || p('Unable to find a container for "'.concat(n, '"'), 3585),
              (m = E);
          } catch (Tr) {
            p(
        ...
        if (T) {
          ...
          var $;
          s.execution =
            ($ = s.execution) !== null && $ !== void 0 ? $ : ue.RENDER;
          var ne;
          s.appearance =
            (ne = s.appearance) !== null && ne !== void 0 ? ne : q.ALWAYS;
          var fe;
          s["retry-interval"] = Number(
            (fe = s["retry-interval"]) !== null && fe !== void 0 ? fe : jt
          );
          var J;
          s["expiry-interval"] = Number(
            (J = s["expiry-interval"]) !== null && J !== void 0
              ? J
              : (kt - Lt) * 1e3
          );
          var pe;
          ...
          typeof L != "string" &&
            p(
              'Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(
                typeof L == "undefined" ? "undefined" : C(L),
                '"'
              ),
              3588
            ),
            Nt(L) ||
              p(
                'Invalid input for parameter "sitekey", got "'.concat(L, '"'),
                3589
              ),
            et(s.size) ||
              p(
          ...
          var ye,
            G =
              (ye = s["refresh-expired"]) !== null && ye !== void 0
                ? ye
                : X.AUTO;
          tt(G)
            ? (s["refresh-expired"] = G)
            : p(
                'Invalid type for parameter "refresh-expired", expected never|manual|auto, got "'
                  .concat(G, '" ')
                  .concat(typeof G == "undefined" ? "undefined" : C(G)),
                3603
              );
          var he,
            ie =
              (he = s["refresh-timeout"]) !== null && he !== void 0
                ? he
                : Z.AUTO;
          rt(G)
            ? (s["refresh-timeout"] = ie)
            : p(
                'Invalid type for parameter "refresh-timeout", expected never|manual|auto, got "'
                  .concat(ie, '" ')
                  .concat(typeof ie == "undefined" ? "undefined" : C(ie)),
                3603
              );
          ...
          if (!(!_e || !ce)) {
            ...
            je || p("Turnstile Initialization Error ", 3606),
              (W.style.display = "none"),
              (W.style.border = "none"),
              (W.style.overflow = "hidden"),
              W.setAttribute("src", lt(_e, L, s, j, K, "g", ot(je))),
              (W.onerror = function () {
                if (H) {
            ...
            N(
              ...
              (W.id = ce);
            var He;
            (W.tabIndex = (He = s.tabindex) !== null && He !== void 0 ? He : 0),
              (W.title = "Widget containing a Cloudflare security challenge"),
              m.appendChild(W);
            var Ve,
              dr =
                (Ve = s["response-field"]) !== null && Ve !== void 0 ? Ve : !0;
            if (dr) {
              ...
              if (
                ((Se.name =
                  (qe = s["response-field-name"]) !== null && qe !== void 0
                    ? qe
                    : Wt),
                (Se.id = "".concat(ce, "_response")),
                m.appendChild(Se),
                typeof s["response-field-name"] != "string" && Er(L))
              ) {
                var Ie = document.createElement("input");
                (Ie.type = "hidden"),
                  (Ie.name = Ft),
                  (Ie.id = "".concat(ce, "_legacy_response")),
                  m.appendChild(Ie);
              }
            }
    ...
    function F() {
      return (
        (F = wt(function (v, n, i, t) {
          var d, f, m, E, T, s, w, O, B, L;
          return Ce(this, function (A) {
            switch (A.label) {
              case 0:
                if (((d = v.params.sitekey), (f = or()), !f))
                  return (
                    x(
              ...
              case 3:
                return [4, O.json()];
              case 4:
                if (((B = A.sent()), "status" in B && B.status === "redeemed"))
                  return r(v, n, !0), [2];
                A.label = 5;
              case 5:
                return [3, 7];
            ...
            switch (n.event) {
              case "init": {
                ...
                f ||
                  ...
                  (t.mode = n.mode),
                  t.mode === U.INVISIBLE &&
                    t.params["refresh-expired"] === X.MANUAL &&
                    x(
                  ...
                  t.mode !== U.MANAGED &&
                    t.params["refresh-timeout"] !== Z.AUTO &&
                    x(
                      "setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."
                    ),
                  t.params.appearance === q.ALWAYS ||
                  (t.isExecuting && t.params.appearance === q.EXECUTE)
                    ? mt(f, t)
                    : ir(f),
                  (f.style.display = "");
                ...
                m ||
                  ...
                  (d = m.contentWindow) === null ||
                    d === void 0 ||
                    d.postMessage(
                      { source: P, widgetId: n.widgetId, event: "init" },
                      "*"
                    );
                break;
              }
              ...
              case "complete": {
                c(t, j, n.widgetId),
                  (t.response = n.token),
                  n.sToken ? e(t, i, n.sToken, n.chlId) : r(t, i, !1);
                break;
              }
              case "fail": {
                ...
                if (O) {
                  var L;
                  O(String((L = n.code) !== null && L !== void 0 ? L : Ct)) ||
                    (n.code && x("Error: ".concat(n.code)), a(t, i, B));
                } else
                  n.code
                    ? (a(t, i, B), p("Error: ".concat(n.code), 3076))
                    : a(t, i, !1);
                break;
              }
              case "feedbackInit": {
              ...
              case "requestFeedbackData": {
                var A,
                  re = document.querySelector("#".concat(i));
                re ||
                  p(
                    "Received state for an unknown widget: ".concat(n.widgetId),
                    3078
                  ),
                  (A = re.contentWindow) === null ||
                    A === void 0 ||
                    A.postMessage(
                      {
                        source: P,
              ...
              case "turnstileResults": {
                var $,
                  ne = document.querySelector("#".concat(i, "-fr"));
                ne ||
                  p(
                    "Received state for an unknown widget: ".concat(n.widgetId),
                    3078
                  ),
                  ($ = ne.contentWindow) === null ||
                    $ === void 0 ||
                    $.postMessage(
                      {
                        source: P,
              ...
              case "tokenExpired": {
                var J,
                  pe = n.token;
                (t.isExpired = !0),
                  (J = t.cbExpired) === null || J === void 0 || J.call(t, pe),
                  t.params["refresh-expired"] === X.AUTO &&
                    !t.isResetting &&
                    _(i);
                break;
              }
              case "interactiveTimeout": {
                ...
                if (
                  (we
                    ? we()
                    : t.params["refresh-timeout"] === Z.NEVER &&
                      !t.isResetting &&
                      x(
                  ...
                  t.params["refresh-timeout"] === Z.AUTO && !t.isResetting)
                ) {
              ...
              case "interactiveBegin": {
                ...
                Te ||
                  ...
                  (me = t.cbBeforeInteractive) === null ||
                    me === void 0 ||
                    me.call(t),
                  t.params.appearance === q.INTERACTION_ONLY && mt(Te, t);
                break;
              }
              case "interactiveEnd": {
                var ge;
                (ge = t.cbAfterInteractive) === null ||
                  ge === void 0 ||
                  ge.call(t);
                break;
              }
          ...
          typeof n != "function" &&
            p(
              'turnstile.ready() expected a "function" argument, got "'.concat(
                typeof n == "undefined" ? "undefined" : C(n),
                '"'
              ),
              3841
            ),
      ...
      execute: function (n, i) {
        ...
        if (f) {
          ...
          f.isExpired &&
            ...
            f.isStale && (_(m), (f.isExecuting = !0)),
            f.msgQueue.push(ee.EXECUTE),
            (f.isExecuted = !0);
          var T = document.querySelector("#".concat(m));
          if (
            (T ||
              ((f.isExecuting = !1),
              p("Widget ".concat(m, " to execute was not found"), 43522)),
            f.isResetting)
          )
            return;
          if (
            (f.isInitialized && g(f, t, T),
            f.isInitialized && f.params.appearance === q.EXECUTE && mt(T, f),
            f.isExecuting)
          ) {
            var s,
              w = document.querySelector("#".concat(m));
            w || p("Received state for an unknown widget: ".concat(t), 3078),
              (s = w.contentWindow) === null ||
                s === void 0 ||
                s.postMessage(
  ...
  function wr(e) {
    ...
    c &&
      (Ye(c) ? (r.theme = c) : x('Unknown data-theme value: "'.concat(c, '"')));
    var u = e.getAttribute("data-size");
    if (
      (u &&
        (et(u) ? (r.size = u) : x('Unknown data-size value: "'.concat(u, '"'))),
      0)
    )
      var g;
    ...
    var d,
      f =
        (d = e.getAttribute("data-response-field")) !== null && d !== void 0
          ? d
          : "true";
  ...
  function cr() {
    ...
    pt(y, e),
      ...
      rr(window.turnstile, y);
  }
  (se = !1),
    (I = Kt()),
    (y.scriptWasLoadedAsync =
      (De = I == null ? void 0 : I.loadedAsync) !== null && De !== void 0
        ? De
        : !1),
    I != null &&
      I.params &&
      ((de = I.params.get("compat")),
      (de == null ? void 0 : de.toLowerCase()) === "recaptcha"
        ? window.grecaptcha
          ? x(
          ...
          : (x("Compatibility layer enabled"),
            ...
            (window.grecaptcha = ht))
        : de !== null &&
          x('Unknown value for api.js?compat: "'.concat(de, '", ignoring')),
      I.params.forEach(function (e, a) {
        N(["onload", "compat", "_cb", "_upgrade", "_reload", "render"], a) ||
          x(
    ...
    gt && !se
      ...
      : (gt &&
          se &&
          (nr(window.turnstile, y),
          ft(y, K),
          (I == null || (Fe = I.params) === null || Fe === void 0
            ? void 0
            : Fe.get("render")) !== "explicit" && setTimeout(yt, 0)),
        (window.turnstile = ht),
        se ||
          ((I == null || (We = I.params) === null || We === void 0
            ? void 0
            : We.get("render")) !== "explicit" && _t.push(yt),
          document.readyState === "complete" ||
          document.readyState === "interactive"
            ? setTimeout(ar, 0)
            : window.addEventListener("DOMContentLoaded", ar))),
    (ur = 24 * 60 * 60 * 1e3),
    window.setTimeout(cr, ur),
    K && (window.turnstile._testUpgrade = cr);
